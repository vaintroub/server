...
INCLUDE(${MYSQL_CMAKE_SCRIPT_DIR}/mysql_add_library.cmake)
...
MACRO(ADD_CONVENIENCE_LIBRARY)
  ...
  MYSQL_ADD_LIBRARY(${TARGET} STATIC ${SOURCES})
  IF(NOT _SKIP_PIC)
...
MACRO(MERGE_STATIC_LIBS TARGET OUTPUT_NAME LIBS_TO_MERGE)
  ...
  MYSQL_ADD_LIBRARY(${TARGET} STATIC ${SOURCE_FILE})
...
MACRO(MERGE_LIBRARIES)
  ...
  ELSEIF(ARG_SHARED OR ARG_MODULE)
    ...
    ENDIF()
    MYSQL_ADD_LIBRARY(${TARGET} ${LIBTYPE} ${SRC})
    IF (ARG_VERSION)
