...
static SYMBOL symbols[] = {
  ...
  { SYM("AT",                     AT_SYM)},
  { SYM("ATOMIC",                 ATOMIC_SYM)},
  { SYM("AUTHORS",	          AUTHORS_SYM)},
  { SYM("AUTO",                   AUTO_SYM)},
  ...
  { SYM("BEGIN",                  BEGIN_MARIADB_SYM)},
  { SYM("BETWEEN",                BETWEEN_SYM)},
  { SYM("BIGINT",                 BIGINT)},
  { SYM("BINARY",                 BINARY)},
  { SYM("BINLOG",                 BINLOG_SYM)},
  { SYM("BIT",                    BIT_SYM)},
  { SYM("BLOB",                   BLOB_MARIADB_SYM)},
  { SYM("BLOCK",                  BLOCK_SYM)},
  { SYM("BODY",                   BODY_MARIADB_SYM)},
  { SYM("BOOL",                   BOOL_SYM)},
  ...
  { SYM("COLUMNS",                COLUMNS)},
  { SYM("COLUMN_ADD",             COLUMN_ADD_SYM)},
  { SYM("COLUMN_CHECK",           COLUMN_CHECK_SYM)},
  { SYM("COLUMN_CREATE",          COLUMN_CREATE_SYM)},
  { SYM("COLUMN_DELETE",          COLUMN_DELETE_SYM)},
  { SYM("COLUMN_GET",             COLUMN_GET_SYM)},
  ...
  { SYM("CONTINUE",               CONTINUE_MARIADB_SYM)},
  { SYM("CONTRIBUTORS",           CONTRIBUTORS_SYM)},
  ...
  { SYM("CURRENT_POS",            CURRENT_POS_SYM)},
  { SYM("CURRENT_ROLE",           CURRENT_ROLE)},
  ...
  { SYM("DO_DOMAIN_IDS",          DO_DOMAIN_IDS_SYM)},
  { SYM("DROP",                   DROP)},
  { SYM("DUAL",                   DUAL_SYM)},
  ...
  { SYM("EACH",                   EACH_SYM)},
  { SYM("ELSE",                   ELSE)},
  { SYM("ELSEIF",                 ELSEIF_MARIADB_SYM)},
  { SYM("ELSIF",                  ELSIF_MARIADB_SYM)},
  { SYM("EMPTY",                  EMPTY_SYM)},
  ...
  { SYM("GENERAL",                GENERAL)},
  { SYM("GENERATED",              GENERATED_SYM)},
  { SYM("GET_FORMAT",             GET_FORMAT)},
  { SYM("GET",                    GET_SYM)},
  { SYM("GLOBAL",                 GLOBAL_SYM)},
  { SYM("GOTO",                   GOTO_MARIADB_SYM)},
  { SYM("GRANT",                  GRANT)},
  { SYM("GRANTS",                 GRANTS)},
  { SYM("GROUP",                  GROUP_SYM)},
  ...
  { SYM("IGNORED",                IGNORED_SYM)},
  { SYM("IGNORE_DOMAIN_IDS",      IGNORE_DOMAIN_IDS_SYM)},
  ...
  { SYM("LAST",                   LAST_SYM)},
  { SYM("LAST_VALUE",             LAST_VALUE)},
  { SYM("LASTVAL",                LASTVAL_SYM)},
  { SYM("LEADING",                LEADING)},
  { SYM("LEAVE",                  LEAVE_SYM)},
  { SYM("LEAVES",                 LEAVES)},
  { SYM("LEFT",                   LEFT)},
  ...
  { SYM("MASTER_GTID_POS",        MASTER_GTID_POS_SYM)},
  ...
  { SYM("MASTER_USE_GTID",        MASTER_USE_GTID_SYM)},
  { SYM("MASTER_DEMOTE_TO_SLAVE", MASTER_DEMOTE_TO_SLAVE_SYM)},
  ...
  { SYM("OTHERS",                 OTHERS_MARIADB_SYM)},
  { SYM("OUT",                    OUT_SYM)},
  { SYM("OUTER",                  OUTER)},
  { SYM("OUTFILE",                OUTFILE)},
  { SYM("OVER",                   OVER_SYM)},
  { SYM("OVERLAPS",               OVERLAPS_SYM)},
  { SYM("OWNER",                  OWNER_SYM)},
  { SYM("PACKAGE",                PACKAGE_MARIADB_SYM)},
  { SYM("PACK_KEYS",              PACK_KEYS_SYM)},
  { SYM("PAGE",	                  PAGE_SYM)},
  { SYM("PAGE_CHECKSUM",          PAGE_CHECKSUM_SYM)},
  { SYM("PARSER",                 PARSER_SYM)},
  { SYM("PARSE_VCOL_EXPR",        PARSE_VCOL_EXPR_SYM)},
  { SYM("PATH",                   PATH_SYM)},
  { SYM("PERIOD",                 PERIOD_SYM)},
  { SYM("PARTIAL",                PARTIAL)},
  { SYM("PARTITION",              PARTITION_SYM)},
  { SYM("PARTITIONING",           PARTITIONING_SYM)},
  { SYM("PARTITIONS",             PARTITIONS_SYM)},
  { SYM("PASSWORD",               PASSWORD_SYM)},
  { SYM("PERSISTENT",             PERSISTENT_SYM)},
  { SYM("PHASE",                  PHASE_SYM)},
  { SYM("PLUGIN",                 PLUGIN_SYM)},
  { SYM("PLUGINS",                PLUGINS_SYM)},
  { SYM("PORT",                   PORT_SYM)},
  { SYM("PORTION",                PORTION_SYM)},
  ...
  { SYM("QUERY",                  QUERY_SYM)},
  { SYM("QUICK",                  QUICK)},
  { SYM("RAISE",                  RAISE_MARIADB_SYM)},
  { SYM("RANGE",                  RANGE_SYM)},
  { SYM("RAW",                    RAW_MARIADB_SYM)},
  { SYM("READ",                   READ_SYM)},
  ...
  { SYM("REPLAY",                 REPLAY_SYM)},
  { SYM("REPLICA",                SLAVE)},
  { SYM("REPLICAS",               SLAVES)},
  { SYM("REPLICA_POS",            SLAVE_POS_SYM)},
  ...
  { SYM("ROW",                    ROW_SYM)},
  { SYM("ROWCOUNT",               ROWCOUNT_SYM)}, /* Oracle-N */
  { SYM("ROWNUM",                 ROWNUM_SYM)}, /* Oracle-R */
  { SYM("ROWS",                   ROWS_SYM)},
  { SYM("ROWTYPE",                ROWTYPE_MARIADB_SYM)},
  ...
  { SYM("REF_SYSTEM_ID",          REF_SYSTEM_ID_SYM)},
  { SYM("SQL",                    SQL_SYM)},
  { SYM("SQLEXCEPTION",           SQLEXCEPTION_SYM)},
  { SYM("SQLSTATE",               SQLSTATE_SYM)},
  { SYM("SQLWARNING",             SQLWARNING_SYM)},
  { SYM("SQL_AFTER_GTIDS",        SQL_AFTER_GTIDS_SYM)},
  { SYM("SQL_BEFORE_GTIDS",       SQL_BEFORE_GTIDS_SYM)},
  ...
  { SYM("SYSDATE",                SYSDATE)},
  { SYM("SYSTEM",                 SYSTEM)},
  { SYM("SYSTEM_TIME",            SYSTEM_TIME_SYM)},
  { SYM("TABLE",                  TABLE_SYM)},
  { SYM("TABLE_NAME",             TABLE_NAME_SYM)},
  { SYM("TABLES",                 TABLES)},
  { SYM("TABLESPACE",	          TABLESPACE)},
  ...
  { SYM("TRANSACTIONAL",          TRANSACTIONAL_SYM)},
  ...
  { SYM("VARCHAR2",               VARCHAR2_MARIADB_SYM)},
...
static SYMBOL sql_functions[] = {
  ...
  */
  ...
  { SYM_FN("CUME_DIST",           CUME_DIST_SYM)},
  { SYM_FN("CURDATE",             CURDATE)},
  { SYM_FN("CURTIME",             CURTIME)},
  { SYM_FN("DATE_ADD",            DATE_ADD_INTERVAL)},
  { SYM_FN("DATE_SUB",            DATE_SUB_INTERVAL)},
  { SYM_FN("DENSE_RANK",          DENSE_RANK_SYM)},
  { SYM_FN("EXTRACT",             EXTRACT_SYM)},
  { SYM_FN("FIRST_VALUE",         FIRST_VALUE_SYM)},
  { SYM_FN("GROUP_CONCAT",        GROUP_CONCAT_SYM)},
  { SYM_FN("JSON_ARRAYAGG",       JSON_ARRAYAGG_SYM)},
  { SYM_FN("JSON_OBJECTAGG",      JSON_OBJECTAGG_SYM)},
  { SYM_FN("LAG",                 LAG_SYM)},
  { SYM_FN("LEAD",                LEAD_SYM)},
  { SYM_FN("MAX",                 MAX_SYM)},
  { SYM_FN("MEDIAN",              MEDIAN_SYM)},
  { SYM_FN("MID",                 SUBSTRING)},	/* unireg function */
  { SYM_FN("MIN",                 MIN_SYM)},
  { SYM_FN("NOW",                 NOW_SYM)},
  { SYM_FN("NTH_VALUE",           NTH_VALUE_SYM)},
  { SYM_FN("NTILE",               NTILE_SYM)},
  { SYM_FN("POSITION",            POSITION_SYM)},
  { SYM_FN("PERCENT_RANK",        PERCENT_RANK_SYM)},
  { SYM_FN("PERCENTILE_CONT",     PERCENTILE_CONT_SYM)},
  { SYM_FN("PERCENTILE_DISC",     PERCENTILE_DISC_SYM)},
  { SYM_FN("RANK",                RANK_SYM)},
  { SYM_FN("SESSION_USER",        USER_SYM)},
  { SYM_FN("STD",                 STD_SYM)},
  ...
  { SYM_FN("SUM",                 SUM_SYM)},
  { SYM_FN("SYSTEM_USER",         USER_SYM)},
  { SYM_FN("TRIM",                TRIM)},
  { SYM_FN("TRIM_ORACLE",         TRIM_ORACLE)},
  { SYM_FN("VARIANCE",            VARIANCE_SYM)},
  { SYM_FN("VAR_POP",             VARIANCE_SYM)},
  { SYM_FN("VAR_SAMP",            VAR_SAMP_SYM)}
};

static size_t __attribute__ ((unused)) symbols_length=
    sizeof(symbols) / sizeof(SYMBOL);
static size_t __attribute__ ((unused)) sql_functions_length=
